...
# Handle case where __file__ is None (e.g., in torch.multiprocessing spawn mode)
def _get_base_dir():
    ...
    workspace = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))))
