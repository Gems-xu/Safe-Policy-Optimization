...
# ==============================================================================
"""
MAPPO-PINN-Point: MAPPO with Port-Hamiltonian Neural Network Actor for Point agents.

This algorithm integrates Physics-Informed Neural Networks (PINN) based on 
Port-Hamiltonian systems into MAPPO's actor network for Point-type agents.
...
if __name__ == '__main__':
    set_np_formatting()
    args, cfg_env, cfg_train = multi_agent_args(algo="mappo_pinn_point")
